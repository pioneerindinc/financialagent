...
Pioneer ERP → versioned integration API → source financial projection / accounting service → reviewed draft → human-authorized posted journal.
