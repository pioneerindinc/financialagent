...
5. Reconcile bank, credit-card and loan balances against statements; import payroll/tax liabilities with their schedules and evidence.
6. Approve equity/opening balance treatment with the accountant. Document retained earnings, historical adjustments and excluded periods.
7. Reconcile Trial Balance per company/account at cutoff. Reconcile AR/AP subledgers to their controls and bank/card/loan/payroll balances independently.
8. Run parallel validation across representative closing cycles. Compare statements and settlements, trace discrepancies and document approval.
9. Freeze source accounting writes only after explicit cutover approval; preserve read-only archives and stable links.
